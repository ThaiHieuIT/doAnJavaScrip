...
function create_order_detail_node(index, order_detail) {
    ...
    order_detail_quantity_minus.setAttribute('class', 'fa-solid fa-minus')
    ...
    order_detail_quantity_plus.setAttribute('class', 'fa-solid fa-plus')
    ...
    order_detail_trash.setAttribute('class', 'btn-delete fa-solid fa-trash')
